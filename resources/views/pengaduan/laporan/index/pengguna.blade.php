                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-transparent mr-2 text-info"
                                        href="/{{Auth::user()->role}}/laporan/{{$item->id}}/edit" role="button"><i
                                            class="fas fa-info-circle"></i><span class="ml-2">Ajukan Kembali</span>
                                    </a>
                                    @else
                                    <a class="btn btn-transparent mr-2 text-info"
                                        href="/{{Auth::user()->role}}/laporan/{{$item->id}}/show" role="button"><i
                                            class="fas fa-info-circle"></i><span class="ml-2">Lihat Tanggapan</span>
                                    </a>
                                    @endif
                                </td>
                            </tr>
