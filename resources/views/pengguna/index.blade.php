                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="small font-weight-bold text-primary mb-1">Laporan Diajukan</div>
                                <div class="h5">{{$laporanDiajukanCount}}</div>
                            </div>
                            <div class="ml-2"><i class="fas fa-clipboard-list fa-2x text-primary"></i></div>
                        </div>
                    </div>
                </div>
            </div>
