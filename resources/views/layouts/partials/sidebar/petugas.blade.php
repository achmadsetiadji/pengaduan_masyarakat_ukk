    ...
    <nav class="sidenav shadow-right sidenav-light">
        <div class="sidenav-menu">
            <div class="nav accordion" id="accordionSidenav">
                ...
                <a class="nav-link collapsed {{ (request()->is('petugas.index')) ? 'active' : '' }}" href="{{ route('petugas.index') }}">
                ...
                <!-- Sidenav Accordion (Dashboard)-->
                <a class="nav-link collapsed {{ (request()->is('laporan*')) ? 'active' : '' }}" href="/petugas/laporan">
